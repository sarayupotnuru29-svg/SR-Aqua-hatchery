...
// import ShrimpPostLarvae from "@/assets/newone.jpg";
// import FarmInfrastructure from "@/assets/newtwo.jpeg";
// import LogisticsandTransport from "@/assets/newthree.jpeg";
...
const galleryItems = [
  ...
  { src: hatcheryTanks, title: "Larval Rearing Tanks", category: "Tanks" },
  { src: shrimpLarvae, title: "Venamei Shrimp Larvae", category: "Larvae" },
  // Your new images added here
  { src: ShrimpPostLarvae, title: "High-Quality Post-Larvae", category: "Seed" },
  { src: FarmInfrastructure, title: "Modern Hatchery Facility", category: "Facility" },
  { src: LogisticsandTransport, title: "Night Delivery Logistics", category: "Transport" },
    ...
    <div className="min-h-screen pt-20">
      ...
      {selected !== null && (
        <div
          ...
          onClick={() => setSelected(null)}
        >
          <div className="max-w-4xl w-full animate-fade-in relative">
            {/* Close Button UI suggestion */}
            <button 
